 ...
 */
class HomeappNavigationControl {
    _map: Map;
    _container: HTMLElement;
    _toggle3d: HTMLElement;
    ...
    constructor(ifZoom) {
        ...
        this._toggle3d = this._createButton('mapboxgl-ctrl-icon mapboxgl-ctrl-toggle-3d', 'Toggle 3D', () => { if(this._map.toggle3d)this._map.toggle3d() } );
        if(ifZoom) {
...
module.exports = HomeappNavigationControl;
